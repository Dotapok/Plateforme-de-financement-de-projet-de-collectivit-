...
import { ArrowLeft, Save, Upload, FileText, MapPin, Calendar, DollarSign, Building2 } from 'lucide-react';
...
export function NewProjectPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      navigate('/projects', { 
        state: { 
          message: 'Projet créé avec succès ! Il est maintenant en attente d\'évaluation.' 
        } 
      });
    } catch (err) {
        ...
        <div className="mb-6 sm:mb-8">
          ...
          <div>
            ...
            <p className="text-sm sm:text-base text-gray-600">
              Créez un nouveau projet de développement territorial
            </p>
          </div>
        </div>
